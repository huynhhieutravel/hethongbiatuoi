		...
		<div class="elementor-star-rating__wrapper">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					...
					<div class="e-gallery-image elementor-gallery-item__image" data-thumbnail="/uploads/he-thong-bia-thap-di-den-cac-vung-tay-nguyen-vung-cao.jpg" data-width="300" data-height="225" aria-label="Hệ Thống Bia Tháp đi đến các vùng Tây Nguyên và vùng cao" role="img" ></div>
											<div class="elementor-gallery-item__overlay"></div>
															<div class="elementor-gallery-item__content">
														<div class="elementor-gallery-item__title">
			...
			<div class="elementor-main-swiper swiper-container">
				<div class="swiper-wrapper">
					...
					<cite class="elementor-testimonial__cite"><span class="elementor-testimonial__name">Lê Ân</span><span class="elementor-testimonial__title">Saler</span></cite>				</div>
						...
						<img decoding="async" src="/uploads/khach-hang-bia.jpg" alt="Lê Ân">
											</div>
											</div>
		</div>
								</div>
					...
					<cite class="elementor-testimonial__cite"><span class="elementor-testimonial__name">Trương An Lộc</span><span class="elementor-testimonial__title">Chủ quán Vĩnh Long</span></cite>				</div>
						<div class="elementor-testimonial__footer">
									<div class="elementor-testimonial__image">
						<img decoding="async" src="/uploads/truong-an-loc.jpg" alt="Trương An Lộc">
											</div>
											</div>
		</div>
								</div>
					...
					<cite class="elementor-testimonial__cite"><span class="elementor-testimonial__name">Thanh Thảo</span><span class="elementor-testimonial__title">Chủ quán Măng Đen</span></cite>				</div>
						<div class="elementor-testimonial__footer">
									<div class="elementor-testimonial__image">
						<img decoding="async" src="/uploads/thanh-thao.jpg" alt="Thanh Thảo">
											</div>
											</div>
		</div>
								</div>
					...
					<cite class="elementor-testimonial__cite"><span class="elementor-testimonial__name">An Nhiên</span><span class="elementor-testimonial__title">Chủ quán Tiền Giang</span></cite>				</div>
						<div class="elementor-testimonial__footer">
									<div class="elementor-testimonial__image">
						<img decoding="async" src="/uploads/an-nhien.jpg" alt="An Nhiên">
											</div>
											</div>
		</div>
								</div>
